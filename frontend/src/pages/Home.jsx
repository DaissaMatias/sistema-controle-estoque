...
export default function Home() {
    ...
    //Filtro dinâmico em tempo real por Nome, Código EAN ou Categoria
                ...
                {carregando ? (
                    ...
                    <div style={styles.cardVazio}>
                        <p style={{ marginBottom: '20px', color: 'var(--texto-preto)' }}>
                            {busca ? 'Nenhum produto encontrado com este termo' : 'Nenhum produto cadastrado no banco de dados.'}
                        </p>
                        {!busca && (
